function [E,validIndexMatrix,vNum,w_in_hidden,w_fully_connected]=MLP_OR_R(X,Y,isSortedTask,vX,vY,hiddenNum,iterNum,prunRate,tX,tY)
	...
	while number<iterNum
		...
		w_clear_Matrix=repmat(validIndexMatrix,);
